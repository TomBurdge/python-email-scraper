...
#make a list of companies from the sites by stripping. This won't work well in many cases and doesn't make multiple words.
company_list = []
for site in site_list:
    company_list.append(site.lstrip('https://www.').rstrip('.co.uk/').rstrip('.com/'))
...
df= pd.DataFrame(data={'Sites':site_list,'Emails':company_list})
